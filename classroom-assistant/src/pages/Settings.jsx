        ...
        return (
          <div className="card">
            <div className="card-header">
              <h5 className="mb-0" style={{ fontWeight: 400, color: '#bbb' }}>Account Settings</h5>
            </div>
            <div className="card-body">
              <form>
                <div className="mb-3">
                  <label htmlFor="username" className="form-label" style={{ fontWeight: 300, color: '#bbb' }}>Username</label>
                  <input type="text" className="form-control" id="username" placeholder="Enter your username" style={{ fontWeight: 300, color: '#bbb', background: '#222', border: '1px solid #444' }} />
                </div>
                <div className="mb-3">
                  <label htmlFor="email" className="form-label" style={{ fontWeight: 300, color: '#bbb' }}>Email</label>
                  <input type="email" className="form-control" id="email" placeholder="Enter your email" style={{ fontWeight: 300, color: '#bbb', background: '#222', border: '1px solid #444' }} />
                </div>
